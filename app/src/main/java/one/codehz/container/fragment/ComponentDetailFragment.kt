...
import one.codehz.container.adapters.HeaderAndFooterAdapter
...
import one.codehz.container.viewholder.ComponentViewHolder
...
//    }
    val historyListAdapter by lazy {
        HeaderAndFooterAdapter<ComponentInfoModel, ComponentViewHolder>(R.layout.component_detail_header, R.layout.component_detail_footer, {}, {}) { item ->
            val (id, type, value) = item
...
//    }
    val historyListLoader by MakeLoaderCallbacks({ context }, { it() }) { ctx ->
        ctx.contentResolver.query(
            ...
            historyListAdapter.updateModelsEx(this)
        }
    }
